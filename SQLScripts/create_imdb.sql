...
DROP TABLE IF EXISTS `name_basics_recent`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `name_basics_recent` (
...
DROP TABLE IF EXISTS `title_akas_recent`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `title_akas_recent` (
...
DROP TABLE IF EXISTS `title_basics_recent`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `title_basics_recent` (
...
DROP TABLE IF EXISTS `title_crew_recent`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `title_crew_recent` (
...
DROP TABLE IF EXISTS `title_episode_recent`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `title_episode_recent` (
...
DROP TABLE IF EXISTS `title_principals_recent`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `title_principals_recent` (
  `tconst` varchar(128) DEFAULT NULL,
...
DROP TABLE IF EXISTS `title_ratings_recent`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `title_ratings_recent` (
  `tconst` varchar(128) NOT NULL,
